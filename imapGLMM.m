...
if exist('GeneralizedLinearMixedModel') == 0
    error('Some crucial toolboxes are missing in your current version of Matlab for imapGLMM to run.')
end
...
if has_fsolve == 1
    ...
    disp('imapGLMM will be computed in parallel mode, you machine might become quite slow during the computation.')
end
