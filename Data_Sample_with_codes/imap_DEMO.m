% This demo script reproduces the analysis reported in the guidebook
...
Nsti=length(unique(IMAGE));% number of image
...
for isp=1:3
    for ipp=1:2
        indxtmp=PredictorM.spotlight==Spotlightsize(isp) & PredictorM.position==Position(ipp);
